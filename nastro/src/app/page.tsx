        ...
        <div className='flex flex-wrap items-center h-screen justify-center'
         >
            ...
            <div className='flex justify-center'>
                <form 
                    className="bg-white p-12 w-[90%] md:w-[35rem] flex flex-col items-center rounded-[1rem] md:rounded-[1rem_10rem] transition-all duration-300"
                    ...
                    <label className="flex flex-col w-full text-gray-700 space-y-4">
                        ...
                        <div className='flex gap-4'>
                            <div className="flex flex-col w-[40%]">
                                ...
                                <button 
                                    className="mt-8 w-[10rem] ml-auto bg-gradient-to-r tracking-widest hover:from-black hover:to-black bg-background text-textColor uppercase py-3 rounded-md shadow-lg transition-all duration-300 transform hover:scale-105"
                                    type="submit"
                                >
                                    Calculate
                                </button>
